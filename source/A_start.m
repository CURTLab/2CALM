...
%CALM Version 4.1  (2-sample Comparative Analysis of 3D Localisation Microscopy data)
...
%
%   CALM is the prototype software platform that allows a comparative analysis of
...
%catch
%	clc
%	isp('The program was aborted by the user')
%	pause(0.01)
%	user_stops;
%end
