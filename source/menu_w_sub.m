function k = menu_w_sub(xHeader,varargin)
...
textPadding = [28 18];   % extra [Width Height] on uicontrols to pad text
uiGap       = 5;       % space between uicontrols
uiBorder    = 20;       % space between edge of figure and any uicontrol
winTopGap   = 160;       % gap between top of screen and top of figure **
winLeftGap  = 180;       % gap between side of screen and side of figure **
winWideMin  = 220;      % minimum window width necessary to show title %%%%%%%%%%%wj
...
%------------------------------------------------------------------------
menuFig = figure( 'WindowStyle', 'modal', ...  %%%'modal'
                  'Units'       ,MenuUnits, ...
                  'Visible'     ,'off', ...
                  'NumberTitle' ,'off', ...
...
set( menuFig, 'Position', [winLeftGap+50 bottom winWide winHigh] );%%%%%%%%%%%%%%%%%%%%%%%wj
...
% adjust all buttons
set( hBtn, {'Position'}, cUIPos, 'HorizontalAlignment','right','FontSize',10);
