...
figure ('OuterPosition', [scrsz(3)/6 scrsz(4)/15 scrsz(4)/0.80 scrsz(4)/1.1]) ;

whitebg('k')
%subplot(2,2,1)
subplot('Position',[0.05, 0.35, 0.45, 0.7])
...
hold on
plotbox3(x(:,1),y(:,1),[0,0]',0)
zlim([min(z)-500,max(z)+500])
title (' Original data: {\it yellow - positiv Z, blue - negativ Z}');

%subplot(2,2,2)
subplot('Position',[0.5, 0.35, 0.55, 0.7])
whitebg('k')
