...
plotbox3(xx,yy,zz,'r')
hold on
plot3(rest_pos(:,1),rest_pos(:,2),rest_pos(:,3),'.b','markerfacecolor','b','markersize',1)
view(2);
...
hold on
 ...
 title([num2str(i),'/',num2str(umax), ' largest primary clusters. Radius ',num2str(radius), 'nm. (blue not in clusters) \newlineSample: ',exname])
