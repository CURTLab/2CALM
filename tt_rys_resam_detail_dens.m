...
ylim([0,1])
xlim([0,max(dis)])
title (['First level: Statistic test of cluster relative density distribution'])
...
title ('First level: Statistic test of cluster curvature distribution')
 ...
 suptitle(['Detailed level: Kolmogorow-Smirnow and Wilcoxon statistic tests for ',num2str(A),' samples with ',num2str(M),' points. \newline',...
           exname1,' and ',exname2])
